...
class TimerTextPanel (timer: Timer[Long]) extends DecoratedGridBagPanel {
  ...
  private val cbHours = newCompo(24)
  private val cbMinutes = newCompo(60)
  private val cbSeconds = newCompo(60)
